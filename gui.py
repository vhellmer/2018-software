...
def submited():
    """
    Runs function when submit button is hit
    """
    allASDTIRpairs()
...
def cdsfilename():
    """
    Opens filename window for when button is pushed
    """
    global cdsfilename
    cdsfilename = tkFileDialog.askopenfilename()
    input_frame.pack()
...
oname = Entry(root, bd =5, relief=FLAT, highlightbackground='darkgray', font=('arial', 25))
o_label = Label(root, text="Name of Organism: ", font=('arial', 25))
o_label.pack()
oname.pack()

B1 = Button(root, text ="Choose cds file", highlightbackground='slategray', command=cdsfilename, font=('arial',20))
B1.pack()

savefile = Entry(root, bd =5, relief=FLAT, highlightbackground='darkgray', font=('arial', 25))
save_label = Label(root, text="Name of file to save results as: ", font=('arial', 25))
save_label.pack()
savefile.pack()
...
def fileclick():
    """
    Builds the find file and submit button for when the user wants to attack genome file
    """
    global file
    global paste
    global input_frame
    global submit_frame
    if(file==True or paste == True):
        input_frame.destroy()
    ...
    #Make choose file button
    B1 = Button(input_frame, text ="Choose file", highlightbackground='slategray', command=genomefilename, font=('arial',20))
    B1.pack()
    ...
    #Makes Submit button 
    B2 = Button(submit_frame, text ="Submit", highlightbackground='slategray', command=submited, font=('arial',20))
    B2.pack()


def pasteclick():
    """
    Builds the text box for when the user wants to copy/paste the genome
    """
    global file
    global paste
    global input_frame
    ...
    L1 = Label(input_frame, text="Please Copy/Paste Genome Below", font=('arial', 25))
    L1.pack()
    E1 =    ScrolledText.ScrolledText(
    master = input_frame,
    wrap   = WORD,
    width  = 80,
    height = 20,
    ...
    E1.pack(padx=10, pady=10, fill= BOTH, expand=True)
    ...
    #Makes Submit button 
    B = Button(submit_frame, text ="Submit", highlightbackground='slategray', command=submited, font=('arial',20))
    B.pack()


#Make radio buttons for file/paste options
v = IntVar()
Radiobutton(root, 
              text="Genome File",
              padx = 20, 
              variable=v, 
              value=1,
              command=fileclick).pack(anchor=W)
Radiobutton(root, 
              text="Copy/Paste",
              padx = 20, 
              variable=v, 
              value=2,
              command=pasteclick).pack(anchor=W)
